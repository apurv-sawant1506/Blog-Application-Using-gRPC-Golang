...
type Blog struct {
	...
	AuthodId string `protobuf:"bytes,2,opt,name=authod_id,json=authodId,proto3" json:"authod_id,omitempty"`
...
func (x *Blog) GetAuthodId() string {
	if x != nil {
		return x.AuthodId
	}
	return ""
...
type CreateBlogRequest struct {
	...
	Blog *Blog `protobuf:"bytes,1,opt,name=blog,proto3" json:"blog,omitempty"` //This blog will not have an id
}
...
type CreateBlogResponse struct {
	...
	Blog *Blog `protobuf:"bytes,1,opt,name=blog,proto3" json:"blog,omitempty"` //This blog will have an id.
}
...
var file_blogpb_blog_proto_rawDesc = []byte{
	...
	0x64, 0x12, 0x1b, 0x0a, 0x09, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x64, 0x5f, 0x69, 0x64, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x64, 0x49, 0x64, 0x12, 0x14,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x0d, 0x5a, 0x0b, 0x62, 0x6c, 0x6f, 0x67, 0x2f,
